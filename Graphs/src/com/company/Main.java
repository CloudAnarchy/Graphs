...
public class Main extends JFrame {
    ...
    public static void main(String[] args) {
        ...
        welcomeText[1] = "<html><h1 style = color:#ff8c1a;>Please Pay Attention!</h1><p>" +
                "Χρησιμοποίησα ένα library για visualization αλλά μόνο για αυτό όλα τα άλλα" +
                "\nτα έχω γράψει από το 0. Στο class MyGraph βρίσκεται όλος ο" +
                "\nκώδικας τα υπόλοιπα πάνω κάτω είναι για τα visuals.Τα οποια " +
                "\nείναι εύχρηστα για να δούμε αν παίζει ο κώδικας";
        welcomeText[0] = "<html><h1 style = color:#ff8000;>Helping Guide.</h1><p>" +
                "\n1. Load a MyGraph:  Κάνει load ένα νέο random γράφο με Ν Edges N Nodes." +
                "\n\n2. Print current MyGraph:  Print τον τρέχων γράφο." +
                "\n\n3. Make an EMPTY MyGraph:  Φτιάχνει ένα νέο άδειο γράφο με V ακμές (παίρνει input)." +
                ...
                "\n\n10. Add a node: Κάνει add ένα node." +
                "\n\n11. Change color of a node: Αλλάζει το χρώμα του node.";
...
//
//
//    private static MyGraph loadGraph(){
//
//        // /*
//        MyGraph graph = new MyGraph(6);
//        graph.addEgde(0, 1, 4);
